	 ...
	 <div class="container-tsp">
        <div class="space">
            ...
            <table class="table table-hover table-bordered">
                ...
                <c:forEach var = "u" items="${dshd}">
           			
					<tr>
						<td>${u.mahd}</td>
						<td><f:formatDate pattern = "MM-dd-yyyy HH:mm" value = "${u.ngaythem}" />  </td>
						<td>${u.trangthai.matthd==1?'Đã thanh toán':'Đã hủy'} </td>
					
						<td><a href="giaodich/quanli/chitiethoadon/${u.mahd}.htm"><i class="fa fa-eye"></i></a>
