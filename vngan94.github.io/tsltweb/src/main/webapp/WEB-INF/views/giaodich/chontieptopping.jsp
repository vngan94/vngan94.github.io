...
<body>
	...
	<form:form action="giaodich/xongtopping.htm" method="post" modelAttribute="cthd">
		<div class="container-tsp">
			${message}
			<c:choose>
				<c:when test="${cthd.hoadon.mahd != 0}"> 
					<form:input class="input-pad4" path="hoadon.mahd" type="hidden" />
				</c:when> 
				<c:otherwise>
					<form:input class="input-pad4" path="hoadon.nhanvien.manv" type="hidden" /> 
				</c:otherwise>
			</c:choose>
			<div class="flex">
			
				<label>Số lượng</label>
				<form:input class="input-pad4" path="soluong" type="number" min="1" max="1000" />
				<label>Chọn size</label>
				<form:select path="topping.matopping" items="${dstp}" itemValue="matopping" itemLabel="topping" />
			</div>
