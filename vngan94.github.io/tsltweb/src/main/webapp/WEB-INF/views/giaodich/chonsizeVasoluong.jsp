...
<body>
	...
	<form:form action="giaodich/xong.htm" method="post" modelAttribute="cthd">
		<div class="container-tsp">
			${message}
			
				<c:if test="${cthd.hoadon.mahd != 0}"> 
					<form:input class="input-pad4" path="hoadon.mahd" type="hidden" />
				</c:if> 
				
			<div class="flex">
				<form:input class="input-pad4" path="trasua.mats" type="hidden" />
				<label>Số lượng</label>
				<form:input class="input-pad4" path="soluong" type="number" min="1" max="1000" />
				<label>Chọn size</label>
				<form:select path="size.masize" items="${dssize}" itemValue="size.masize" itemLabel="size.tensize" />
			</div>
