...
<body>
	...
	<div class="container-tsp flex">
		...
		<form:form action="giaodich/gettsvanhanvien.htm" method="post"
			modelAttribute="cthd">
				...
				<div class="flex">
					...
					<div>
						<div class="pad-2 so-luong">
							<label class="pad-4">Chọn nhân viên lập</label>
							<form:select path="hoadon.nhanvien.manv" items="${dsnv}"
								itemValue="manv" itemLabel="ten" />
						</div>
						<label>Chọn trà sữa</label>
						<form:input class="input-pad4" path="hoadon.mahd" type="hidden" />
						<form:select path="trasua.mats" items="${dsts}" itemValue="mats"
							itemLabel="tents"  style = "width: 30%;  margin-bottom: 10px"/>
					</div>
