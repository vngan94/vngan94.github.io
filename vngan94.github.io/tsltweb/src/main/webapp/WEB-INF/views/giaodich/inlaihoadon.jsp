...
<body>
	...
	<div class="container-tsp">
		<div class="space">
			<h3>Chi tiết hóa đơn ${dscthd[0].hoadon.mahd}</h3>
			
				<a href="giaodich/chontieptrasua/${dscthd[0].hoadon.mahd}.htm">Chọn tiếp trà sữa</a>
				<a href="giaodich/chontieptopping/${dscthd[0].hoadon.mahd}.htm">Chọn tiếp topping</a>
				<a href="giaodich/inhoadon/${dscthd[0].hoadon.mahd}.htm">In hóa đơn</a>
			...
			<tbody>
				<c:forEach var="u" items="${dscthd}">
					<tr>
						...
						<td><a href="giaodich/xoacthd/${u.macthd}.htm"><i class="fa fa-eraser"></i></a> <a href="giaodich/editcthd/${u.macthd}.htm"><i class="fa fa-edit"></i></a> </td>
					</tr>
		...
		<a href="giaodich/xoatatca/${dscthd[0].hoadon.mahd}.htm">Xóa tất cả</a>
	</div>
