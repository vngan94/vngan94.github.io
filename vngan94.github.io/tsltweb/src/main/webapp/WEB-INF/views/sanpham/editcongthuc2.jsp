		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<form:form method="post" modelAttribute="ct">
					<form:input path="trasua.mats" type="hidden" />
					<form:input path="nguyenlieu.manl" type="hidden" />
					<!-- khong can hidden mact vi tu no di kem vs ct, phai the bo 2 dong tren vi no se ko xac dinh duoc 2 ma khi save -->
					<tr>
						
						<td><form:input path="nguyenlieu.tennl" type="text"
								readonly="true" /></td>
						<td><form:input path="lieuluong" type="number" min="0.1"
								max="100" step="0.1" /></td>
						<td><form:input path="donvi" type="text" /></td>
						<td>
