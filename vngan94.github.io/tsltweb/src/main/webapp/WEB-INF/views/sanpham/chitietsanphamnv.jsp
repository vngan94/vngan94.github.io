...
<c:choose>
    ...
    <div class="container-tsp flex">
        ...
        <div>
            ...
            <ul>
                <li> <p><b>Mã sản phẩm:</b>  ${trasua.mats}</p>    </li> 
                 ...
                 <li> <p><b> Size </b>  </p> 
                 	<ul>
                 		 <c:forEach var="u" items="${dscts}">
                	  			<li> <p> <b>Size: ${u.size.tensize} </b> - <f:formatNumber value=" ${u.size.tile * trasua.gia}" maxFractionDigits = "0" type="number"/>đ</p> </li>
                  		</c:forEach>
                 	</ul>
                 </li>
              	<li> <p><b> Nguyên liệu </b></p>
