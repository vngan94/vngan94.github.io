...
<body>
	...
	<div class="container-tsp">
		<div class="space">
			...
			<a href="sanpham/quanli/themnguyenlieu/${mats}.htm">Thêm Nguyên liệu</a>
		</div>
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<form:form method="post" modelAttribute="dsct">
					<c:forEach var="u" items="${dsct}">

						<tr>
							<td>${u.nguyenlieu.manl}</td>
							<td>${u.nguyenlieu.tennl}</td>
							<td>${u.lieuluong}</td>
							<td>${u.donvi}</td>
							<td><a
								href="sanpham/deletecongthuc/${u.mact}.htm"><i
									class="fa fa-eraser"></i></a> <a
								href="sanpham/editcongthuc2/${u.mact}.htm"><i
