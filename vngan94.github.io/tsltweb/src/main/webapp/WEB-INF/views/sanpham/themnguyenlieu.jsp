...
<body>
    ...
    <!-- Header End -->
     <form:form action="" method = "post" modelAttribute="ct">
	 <div class="container-tsp pad-2">
        	${message}
            <div>
                <label>Thông tin nguyên liệu</label>
                <form:select path="nguyenlieu.manl" items="${dsnl}" itemValue="manl" itemLabel="tennl"/>
             </div>
             <div>
                <label>Nhập liều lượng</label>
                <form:input path="lieuluong" type="number" min="0.1" max="100" step="0.1" placeholder="Nhập liều lượng"/>
              	
               </div>
              <div>
               	<label>Nhập đơn vị</label>
                <form:input path="donvi" type="text" placeholer="Nhập đơn vị"/>
            </div>
