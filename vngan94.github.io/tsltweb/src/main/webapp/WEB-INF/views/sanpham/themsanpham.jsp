...
<body>
    ...
    <!-- Header End -->
     <form:form action="" method = "post" modelAttribute="trasua" enctype="multipart/form-data">
	 <div class="container-tsp flex">
         <div>
            ...
            <label>Tên sản phẩm</label>
            	...
            	<form:input class="input-pad4"  type="text" path="tents" placeholder="Nhập tên sản phẩm" />
           
      		  </div>
	
	        <div class="pad-2">
	            <label >Mô tả sản phẩm</label>
	            <form:input class="input-pad4"  type="text" path="mota" placeholder="Mô tả sản phẩm" />
	           
	        </div>

	        <div class="pad-2">
	            <label>Giá</label>
	            <form:input class="input-pad2 trangthai" type="number"  min="20000" max="100000" step="1000" placeholder="Nhập giá" path="gia" />
