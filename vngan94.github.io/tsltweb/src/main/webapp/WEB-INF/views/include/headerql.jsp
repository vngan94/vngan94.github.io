                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                ...
                                <a href="sanpham/quanli/themsanpham.htm" class="dropdown-item">Thêm sản phẩm</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Quản lý tài khoản</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="taikhoan/danhsachtaikhoan.htm" class="dropdown-item">Tài khoản</a>
                                <a href="taikhoan/danhsachnhanvien.htm" class="dropdown-item"> Nhân viên</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Giao dịch</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="giaodich/quanli/danhsachhoadon.htm" class="dropdown-item">Hóa đơn</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                ...
                                <a href="thongke/doanhthu.htm" class="dropdown-item">Doanh thu theo năm</a>
                                <a href="thongke/doanhthuthang.htm" class="dropdown-item">Doanh thu theo tháng</a>
