...
<body>
	...
	<div class="container-tsp">
			<div class="space">
				...
				<div class="mr-4">
					<form action="thongke/thongketdoanhthutheothang.htm" class="d-inline-flex mb-5"
						style="float: right">
						<input name="nam" class="form-control me-2" placeholder="Nhập năm"
							type="number" min="2012" max="2022">
						
						<button class="btn btn-outline-info">Tìm</button>
					</form>
				</div>
			</div>
		</div>
