...
<body>
   <c:choose>
    ...
    <!-- Header End -->
     <form:form action="" method = "post" modelAttribute="nguyenlieu">
	 <div class="container-tsp flex">
         <div>
         	<h3 class="title"> THÔNG TIN NGUYÊN LIỆU</h3>
         	 ${message}
   			 <div class="pad-2">
            <label>Tên nguyên liệu</label>
            	<form:input class="input-pad4"  type="text" path="tennl" placeholder="Nhập tên nguyên liệu" />
      		  </div>
	
	        <div class="pad-2">
	            <label >Số lượng</label>
	            <form:input class="input-pad4"  type="number"  min="1" max="100000"  path="soluong" placeholder="Nhập số lượng" />
	        </div>

	        <div class="pad-2">
	            <label>Đơn vị</label>
	           <form:input class="input-pad4"  type="text" path="donvi" placeholder="Nhập đơn vị" />
	        </div>
	        <div class="pad-2">
	            <div>
