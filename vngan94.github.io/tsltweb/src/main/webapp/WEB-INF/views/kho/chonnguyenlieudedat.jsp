...
<body>
    ...
    <!-- Header End -->
     ...
     <form:form action="kho/insertnguyenlieu/${maddh}.htm" method = "post" modelAttribute="ctddh">
	 ...
	 <div class="container-tsp">
          ...
          <div class="flex">
            <div>
                ...
                <form:select path="nguyenlieu.manl" items="${dsctcc}" itemValue="nguyenlieu.manl" itemLabel="nguyenlieu.tennl"/>
            </div>
             <div class="pad-2">
            <label>Số lượng</label>
            	<form:input class="input-pad4"  path="soluong" type="number" min="1" max="100" placeholder="Nhập số lượng" />
      		  </div>
