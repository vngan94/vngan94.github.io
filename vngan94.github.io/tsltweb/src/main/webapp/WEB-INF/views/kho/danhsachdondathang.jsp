   ...
   <c:choose>
    ...
    <!-- Header End -->
	 <div class="container-tsp">
        <div class="space">
        	${message}
            <h3>Danh sách đơn đặt nguyên liệu</h3>  
        </div>
            ...
            <table class="table table-hover table-bordered">
                ...
                <c:forEach var = "u" items="${dsddh}">
           			
					<tr>
						<td>${u.maddh}</td>
						<td><f:formatDate pattern = "MM-dd-yyyy" value = "${u.ngaylap}" /> </td>
						<td>${u.trangthai.tentt} </td>
						
					
			<td><a href="kho/chitietdondatnguyenlieu/${u.maddh}.htm"><i class="fa fa-eye"></i></a></td>
