...
<body>
    ...
    <!-- Header End -->
     ...
     <form:form action="" method = "post" modelAttribute="dondathang">
     	
         	<h3 class="title"> Đặt nguyên liệu</h3>
         	 ${message}
   		
            <div class="pad-2 so-luong">
                <label class="pad-4">Chọn nhà cung cấp</label>
                 <form:select path="nhacungcap.mancc" items="${dsncc}" itemValue="mancc" itemLabel="tenncc" style="width:40%"/>
            </div>
