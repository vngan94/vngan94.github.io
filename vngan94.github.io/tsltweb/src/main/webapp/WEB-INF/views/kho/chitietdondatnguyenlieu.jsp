...
<body>
    ...
    <!-- Header End -->
	 <div class="container-tsp">
        <div class="space">
            <h3>Chi Tiết mã đơn đặt  ${dsctddh[0].dondathang.maddh} 
        			<f:formatDate value="${dsctddh[0].dondathang.ngaylap}" pattern="MM/dd/yyyy"/> </h3>  
            <c:choose>
				<c:when test="${dsctddh[0].dondathang.trangthai.mattddh==1}"><td><a href="kho/huyddh/${dsctddh[0].dondathang.maddh}.htm"><i class="fa fa-eraser"></i></a></td></c:when>
				<c:when test="${dsctddh[0].dondathang.trangthai.mattddh==3}"><td><a href="kho/nhaphang/${dsctddh[0].dondathang.maddh}.htm"><i class="fa fa-check-circle"></i></a></td></c:when>
